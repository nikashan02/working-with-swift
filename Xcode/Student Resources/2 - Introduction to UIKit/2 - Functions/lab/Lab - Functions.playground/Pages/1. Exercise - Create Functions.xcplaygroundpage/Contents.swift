 ...
 */
func introduceMyself(as name: String) {
    print("Hi, my name is \(name).")
}
introduceMyself(as: "Nikashan")
/*:
...
func magicEightBall() {
    ...
    switch randomNum {
    case 1:
        print("You got number 1")
    case 2:
        print("You got number 2")
    case 3:
        print("You got number 3")
    default:
        print("You got number 4")
    }
}
magicEightBall()
